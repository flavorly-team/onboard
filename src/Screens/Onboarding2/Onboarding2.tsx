...
import PlaceholderImage from "../../../assets/images/flavorly-on2.png"
...
export const Onboarding2 = (props: { onNavigate: (string: RootScreens) => void }) => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.quoteContainer}>
        <Text style={styles.quote}>{i18n.t(LocalizationKey.ON2_QUOTE)}</Text>
        <Text style={styles.subquote}>{i18n.t(LocalizationKey.ON2_SUBQUOTE)}</Text>
      </View>
